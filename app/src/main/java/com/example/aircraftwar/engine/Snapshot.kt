...
data class FrameSnapshot(
    ...
    fun toJson(): String = JSONObject().apply {
        ...
        if (scoreRed != null) put("scoreRed", scoreRed)
        if (scoreBlue != null) put("scoreBlue", scoreBlue)
    ...
    companion object {
        ...
        fun fromJson(json: String): FrameSnapshot = JSONObject(json).let {
            FrameSnapshot(
                ...
                scoreRed = if (it.has("scoreRed")) it.getInt("scoreRed") else null,
                scoreBlue = if (it.has("scoreBlue")) it.getInt("scoreBlue") else null,
